...
import Foreign.Hoppy.Generator.Types (boolT, intT, voidT, bitspaceT, constT, objT, ptrT, refT)
...
c_QFile =
  ...
  , just $ mkMethod' "open" "openWithFileDescAndFlags" [intT, bitspaceT bs_OpenMode, bitspaceT bs_FileHandleFlags] boolT
  , just $ mkStaticMethod' "permissions" "permissionsStatic" [refT $ constT $ objT c_QString] $ bitspaceT bs_Permissions
  ...
  , just $ mkStaticMethod' "setPermissions" "setPermissionsStatic" [refT $ constT $ objT c_QString, bitspaceT bs_Permissions] boolT
